...
keywords: ["Generative Search Infrastructure", "AI Ready Web Architecture", "Semantic Web", "JSON LD", "Astro Framework"]
tags: ["Architecture", "Generative Search", "Web Development"]
---
...
When [Tim Berners Lee](https://en.wikipedia.org/wiki/Tim_Berners_Lee) originally envisioned the semantic web he dreamed of machines perfectly understanding data. For decades the industry ignored that vision. We built sites purely for human eyes and completely ignored the machine layer.
